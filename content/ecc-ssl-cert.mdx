...
image: '/markdown/ecc-ssl/ecc.png'
summary: 'A guide on how to generate ECC SSL certificates or sign request'
---
...
![https://www.globalsign.com/en/blog/elliptic-curve-cryptography (Date: 08.04.2023)](/markdown/ecc-ssl/key-size-comparison.jpg)
...
![https://dev.to/benjaminblack/obtaining-an-elliptic-curve-dsa-certificate-with-lets-encrypt-51bc (Date: 08.04.2023)](/markdown/ecc-ssl/ecc-sll-key-chrome.png)

Mozilla Observatory will also give us an A+ rating!

![https://dev.to/benjaminblack/obtaining-an-elliptic-curve-dsa-certificate-with-lets-encrypt-51bc (Date: 08.04.2023)](/markdown/ecc-ssl/ecc-ssl-key-mozilla.png)

In addition, we can see that a 384-bit ECC certificate was used as a result of the SSL Labs report.

![SSL Labs Test Result](/markdown/ecc-ssl/ecc-ssl-key-ssllabs.png)
