---
title: 'An in-depth and comprehensive OpenVPN review'
publishedAt: '2022-03-27'
summary: 'An in-depth review of OpenVPN, explaining the process from connection initiation to data decryption.'
image: '/markdown/openvpn-full/openvpn.webp'
---
...
![https://blog.shiftasia.com/what-happen-when-access-website (Date: 08.04.2023)](/markdown/openvpn-full/TCP-Handshake.jpg)

---

![https://www.netscout.com/blog/asert/ddos-attacks-ssl-something-old-something-new (Date: 08.04.2023)](/markdown/openvpn-full/TCP-Handshake-2.png)
...
![https://www.researchgate.net/publication/298065605_A_multi-level_framework_to_identify_HTTPS_services (Date: 08.04.2023)](/markdown/openvpn-full/TLS-Handshake.png)

---

![](/markdown/openvpn-full/TLS-Handshake-2.png)
...
![https://community.openvpn.net/openvpn/wiki/Gigabit_Networks_Linux (Date: 08.04.2023)](/markdown/openvpn-full/TAP-TUN.png)
