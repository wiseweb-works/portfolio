...
image: '/markdown/ssl-security/ssl.png'
summary: 'A guide to how to improve SSL config on Linux servers'
---
...
BEFORE
![SSL Labs test result](/markdown/ssl-security/ssl-ilk-hali-ssllabs.png)

AFTER
![SSL Labs test result](/markdown/ssl-security/ssl-son-hali-ssllabs.png)
