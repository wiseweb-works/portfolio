...
image: '/images/ssl-security/ssl.png'
...
BEFORE
![SSL Labs test result](/images/ssl-security/ssl-ilk-hali-ssllabs.png)

AFTER
![SSL Labs test result](/images/ssl-security/ssl-son-hali-ssllabs.png)
